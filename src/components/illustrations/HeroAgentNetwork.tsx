    ...
    >
      ...
      {satellites.map((s, i) => (
        <motion.g key={`sat-${i}`} variants={fadeInChild}>
          ...
          {i === 0 && (
            ...
            <g stroke="var(--rz-accent)" strokeWidth={1.2} strokeLinecap="round">
          ...
          {i === 1 && (
            /* Writer: pen nib */
            <g stroke="var(--rz-accent)" strokeWidth={1.2} strokeLinecap="round" strokeLinejoin="round" fill="none">
          ...
          {i === 3 && (
            ...
            <g>
              <circle cx={200} cy={290} r={8} stroke="var(--rz-accent)" strokeWidth={0.8} fill="none" />
              <polyline
          ...
          {i === 4 && (
            ...
            <g stroke="var(--rz-accent)" strokeWidth={1.2} fill="none" strokeLinejoin="round">
          ...
          {i === 5 && (
            ...
            <g stroke="var(--rz-accent)" strokeWidth={1.2} fill="none">
      ...
      <motion.g variants={fadeInChild}>
        ...
        >
          ...
          <g stroke="var(--rz-accent)" strokeWidth={1} strokeLinecap="round" fill="none">
          ...
          {/* Neural dots */}
          <circle cx={188} cy={180} r={2} fill="var(--rz-accent)" />
          <circle cx={212} cy={180} r={2} fill="var(--rz-accent)" />
          <circle cx={195} cy={170} r={1.5} fill="var(--rz-accent)" />
          <circle cx={205} cy={170} r={1.5} fill="var(--rz-accent)" />
          <circle cx={205} cy={190} r={1.5} fill="var(--rz-accent)" />
          <circle cx={195} cy={190} r={1.5} fill="var(--rz-accent)" />
