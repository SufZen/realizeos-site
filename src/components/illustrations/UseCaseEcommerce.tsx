  ...
  return (
    ...
    >
      ...
      <motion.g variants={fadeInChild}>
        ...
        />
        {/* Wheels */}
        <circle cx={22} cy={44} r={3} stroke="var(--rz-fg-muted)" strokeWidth={1.5} fill="none" />
        <circle cx={34} cy={44} r={3} stroke="var(--rz-fg-muted)" strokeWidth={1.5} fill="none" />
        {/* Axle lines */}
        <line x1={19} y1={40} x2={22} y2={41} stroke="var(--rz-fg-muted)" strokeWidth={0.8} />
        <line x1={37} y1={40} x2={34} y2={41} stroke="var(--rz-fg-muted)" strokeWidth={0.8} />
      </motion.g>
      ...
      >
        ...
        />
        {/* Tag hole */}
        <circle cx={39} cy={11} r={1} stroke="var(--rz-accent)" strokeWidth={0.6} fill="none" />
        {/* $ sign */}
